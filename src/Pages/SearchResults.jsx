  ...
  useEffect(() => {
    ...
    const fetchFlights = async () => {
      ...
      try {
        ...
        const res = await fetch(`http://localhost:5000/search-flights?${params.toString()}`);
      ...
      <div className="min-h-screen bg-gray-50 px-4 py-10">
        {loading && (
          <div className="flex justify-center items-center mt-8">
            ...
            <span className="ml-3 text-blue-600 text-sm">Fetching flight data...</span>
          </div>
        )}
        ...
        {!loading && !error && flightResults.length === 0 && (
          <p className="text-center text-gray-500 mt-10">No flights found for the selected route.</p>
        )}

        {!loading && paginatedFlights.length > 0 && (
          <section className="max-w-6xl mx-auto px-4 py-10">
            <h2 className="text-3xl font-bold mb-8 text-indigo-900">Flight Search Results</h2>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-700">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{parseDuration(flight.duration)}</p>
                    </div>
                    ...
                    {flight.returnItinerary && (
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-xs">
                            {new Date(
                              flight.returnItinerary.segments
                                .slice(-1)[0]
                                .arrival.at
                            ).toLocaleString()}
                          </p>
                        ...
                        <div>
                          ...
                          <p className="font-medium">{parseDuration(flight.returnItinerary.duration)}</p>
                        </div>
                      </>
                    )}
                    ...
                    <div>
                      <button
                        ...
                        className="justify-end bg-indigo-800 px-4 py-2 text-white font-semibold rounded-3xl cursor-pointer transition duration-300 active:scale-[0.9] mt-2"
                      >
                        Book Now
                      </button>
                    </div>
